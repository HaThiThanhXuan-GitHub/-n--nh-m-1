...
namespace WindowsFormsApplication1
{
    class Themsuaxoa
    {
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-497ICV3\MSSQLSV;Initial Catalog=QLTHUVIEN;Integrated Security=True");//biến con sqlconection để kêt nối đến CSDL
